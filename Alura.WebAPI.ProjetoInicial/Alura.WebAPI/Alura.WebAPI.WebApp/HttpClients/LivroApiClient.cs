...
namespace Alura.ListaLeitura.HttpClients
{
    public class LivroApiClient
    {
        ...
        public LivroApiClient(HttpClient httpClient, IHttpContextAccessor auth)
        {
        ...
        {
            var token = _auth.HttpContext.User.Claims.First(c => c.Type == "Token").Value;
        ...
        {
            AddBearerToken();
            var resposta = await _httpClient.GetAsync($"listasleituras/{tipo}");
